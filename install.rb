...
Swfupload::InstallHelpers::copy_files '',["_swfupload_form.html.erb"],File.join('app','views','shared')
Swfupload::InstallHelpers::copy_files '',["session_flash_support.rb"],File.join('config','initializers')
rescue Exception => e
	puts "e=#{e}"
end
